...
<style>
	...
	<h1 style="text-align:center;font-size:7;color:white;font-family:Adobe Fan Heiti Std">FORGOT PASSWORD</h1>
	<form name="forgotForm" method="post" style="text-align:center;">
	<input type="text" placeholder="Username" id="userName" name="userName" /required><br/>
	<input type="button"  name="Forgot" id="btnSubmit" value="Submit" onClick="forgotPass()" />
